 ...
 */
 ...
 void ImageWriter::startDfu()
 {
     ...
     {
         _dfuthread->setImageInfo(_dfuBoard, _dfuImageType, _dfuDistro, _dfuVariant);
     }
 ...
 void ImageWriter::setDfuImageParams(const QString &board, const QString &imageType, 
                                      const QString &distro, const QString &variant)
 {
     _dfuBoard = board;
